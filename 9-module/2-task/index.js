...
export default class Main {
  ...
  async render() {
    ...
    document.body.addEventListener('product-add', (e) => {
      let clickedProduct = this.products.find(product => product.id === e.detail);
      this.cart.addProduct(clickedProduct);
    }); 
    ...
    document.body.addEventListener('change', (e) => {
      ...
      } else if (e.target.id === 'vegeterian-checkbox') {
        this.productsGrid.updateFilter({
  ...
  renderCart() {
    let cartWrapper = document.querySelector('[data-cart-icon-holder]');
    this.cartIcon = new CartIcon();
    cartWrapper.append(this.cartIcon.elem);
  };
